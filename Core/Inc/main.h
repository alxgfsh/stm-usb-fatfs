...
#define LED_PB2_GPIO_Port GPIOB
#define LED_PB10_Pin GPIO_PIN_10
#define LED_PB10_GPIO_Port GPIOB
#define LED_PB12_Pin GPIO_PIN_12
#define LED_PB12_GPIO_Port GPIOB
